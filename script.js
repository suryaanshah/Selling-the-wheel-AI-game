var gateswinger = `
You are Mr. Marble living near ancient Egypt. You are the owner of a stone quarry. You cut limestones and offer granite sandstones and special marbles of the best quality. You wish to supply your stones to the pharaoh for building the first pyramid. 
...
var progressive = `
You are the chief engineer of the Pharaoh building the first pyramid. You have just bought hundereds of sledges to move big stones around. 
...
var customer = new WizardOrpheus('', `Your name is Alex.` + customer_types[customer_id]);
...
var salesperson = new WizardOrpheus('', `You will generate tipes for selling style for the user.` + salesperson_types + ` Introduce yourself to the salesperson.`);
...
customer.createUserAction({
  name: 'message',
  parameters: ['Message from the customer to user salesperson'],
  howBotShouldHandle: 'Respond to the user salesperson'
})
